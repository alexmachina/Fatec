	    ...
	    <div class="row">
	       <div class="faixa-post col-xs-12">
               ...
               <article class="container-post col-sm-3 col-xs-12 col-lg-offset-1">
                   ...
                   <p>Mauris laoreet tristique lectus, at accumsan diam ornare vel. Nulla vel arcu vitae diam volutpat condimentum. Sed non convallis turpis. Vivamus lobortis accumsan finibus. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.</p>
                   <p><li><b>Os estilos dos códigos devem ser consistentes - </b>Integer sit amet nisl lectus. Suspendisse non dictum tortor. Etiam ut erat viverra augue tincidunt laoreet at feugiat nisi. Sed pretium tempor justo a eleifend.</li></p>
                    <p><li><b>O código deve respeitar algumas normas métricas - </b>Sed euismod massa non ultrices elementum. Etiam non justo id mi venenatis ultrices quis eu urna. Curabitur rhoncus varius vehicula. Sed laoreet ultricies purus vel porta. Nulla facilisi.</li></p>
                    <p><li><b>Hacks devem ser evitados - </b>Cras suscipit massa vitae nibh consequat, id mattis ex lobortis. Pellentesque quis magna sed urna pharetra condimentum. Proin turpis nibh, viverra at cursus vel, tincidunt ac velit. Sed et quam at metus vulputate lobortis non blandit lorem.</li></p>
                    <p>Nam vehicula a justo nec egestas. Quisque porta ut nulla non blandit. Nulla pharetra nunc quis dolor imperdiet, pretium interdum erat commodo. Sed dictum, ipsum vel blandit dictum, purus metus viverra eros, in gravida tellus orci at est.</p>
