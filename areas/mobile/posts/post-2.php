...
include '../../../templates/header.php'; ?>
    ...
    <div class="container-fluid postGeral post2">
         ...
         <div class="row">
             ...
             <h1 class="text-center">Retrofit, um cliente HTTP simples para Android e Java</h1>
