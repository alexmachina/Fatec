		...
		<div class="row">
			...
			<div class="row">
				<article class="col-xs-12">
					<div class="check-article col-xs-12">
						<ul>
							<li>
							...
							<li>
								...
								<span class="glyphicon glyphicon-dot purple"></span>
								<a href="<?php echo $path; ?>areas/ux/postuxa.php">Mobile em um novo olhar sobre o design</a>
							</li>
							<li>

								<span class="glyphicon glyphicon-dot green"></span>
								<a href="<?php echo $path; ?>areas/javascript/posts/post-1.php">
