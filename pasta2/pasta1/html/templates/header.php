...
<style>
<?php include '../vendor/bootstrap/dist/css/bootstrap.min.css'; ?>
<?php include '../vendor/prism/dist/css/prism.css'; ?>
<?php include '../css/bootstrap-theme.css'; ?>
<?php include '../vendor/bootstrap/dist/css/bootstrap.min.css'; ?>
<?php include '../css/comum/parceiros.css'; ?>
<?php include '../css/comum/quem-somos.css'; ?>
<?php include '../vendor/bootstrap/dist/css/bootstrap.min.css'; ?>
</style>
		<!-- CSS Libs -->
		...
		<div class="container-fluid">
			...
			<div class="row row-nav-baixo">
				<nav class="navbar navbar-nav nav-baixo text-center col-xs-12">
					...
					<div class="col-sm-8  col-xs-12 col-md-offset-3 col-lg-offset-4 col-sm-offset-3 collapse navbar-collapse" id="nav-baixo">
						...
						<li><a href="<?php echo $path; ?>areas/javascript/index.php">
							...
							JavaScript</a></li>
							<li><a href="/areas/ux/homeux.php"><span class="glyphicon glyphicon-dot purple"></span>
								Design e UX</a></li>
								<li><a href="/areas/html/html-e-css.php"><span class="glyphicon glyphicon-dot orange"></span>
									HTML e CSS</a></li>
									...
									<ul class="visible-xs nav navbar-nav nav-baixo">
										<li class="hidden"><a href="#">Contato</a></li>
										<li><a href="/comum/quem-somos.php">Quem Somos</a></li>
										<li><a href="/comum/normas.php">Normas de Utilização</a></li>
										<li><a href="/comum/parceiros.php">Parceiros</a></li>
									</ul>
								</nav>
							</div>
						</header>
